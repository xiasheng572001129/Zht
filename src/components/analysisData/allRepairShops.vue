...
export default {
  ...
  methods: {
    ...
    drawLine () {
      ...
      //售卡平均------------------------------------------------------
      this.$axios.post('analy/shCard', { token: this.token, province: province, pro_id: provinceId }).then(res => {
        var hischart4 = {
          grid: {
            left: '3%',
            right: '4%',
      ...
      //金额平均---------------------------------------------------------------------------
      this.$axios.post('analy/shPrice', { token: this.token, province: province, pro_id: provinceId }).then(res => {
        var hischart5 = {
          grid: {
            left: '3%',
            right: '4%',

...
export default {
  ...
  methods: {
    ...
    drawLine () {
      ...
      //售卡平均------------------------------------------------------
      this.$axios.post('analy/agCard', { token: this.token, province: province, pro_id: provinceId }).then(res => {
        var hischart4 = {
          grid: {
            left: '3%',
            right: '4%',
      ...
      //金额平均---------------------------------------------------------------------------
      this.$axios.post('analy/agPrice', { token: this.token, province: province, pro_id: provinceId }).then(res => {
        var hischart5 = {
          grid: {
            left: '3%',
            right: '4%',
...
.sidebar >>> .two {
  background: url("../../../static/images/shujvfenxi/icblue2.png") !important;
}
.repairShop {
  height: 2100px;
  width: 100%;

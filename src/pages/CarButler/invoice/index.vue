<template>
  <div>
    <ctbHead>
      <router-link active-class="cur" v-for="(item,index) in authList" :key="index" :to="{path:item.action,query:{id:curId}}" >
        {{item.name}}
    ...
    <div class="container">
      <div class="quote">
        <div class="quote-ele"><i></i>邦保养会员车管家-发票管理</div>
        <div class="quote-nav">

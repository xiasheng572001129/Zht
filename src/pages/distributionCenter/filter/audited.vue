<template>
  <div>
    ...
    <div class="container">
      <div class="quote">
        <div class="quote-ele"><i></i>配送中心-机滤审核-已审核</div>
        <div class="quote-nav">
...
export default {
  ...
  methods: {
    ...
    init () {
      this.$axios.post('admin/AgentActivity/index', { token: this.token, page: this.page, status: 1, audit_status: 1, type: 1 })
        .then(res => {
            ...
            for (var i = 0; i < arr.length; i++) {
              if (arr[i].son) {
                ...
                for (var j = 0; j < arr[i].son.length; j++) {
                  ...
                  if (arr[i].son[j].name == '已审核' && arr[i].name == '机滤审核') {

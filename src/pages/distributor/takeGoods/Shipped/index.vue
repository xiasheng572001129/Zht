    ...
    <div>
        <div>
            <el-table :data="tableData"  style="width: 100%" >
                ...
                <el-table-column prop="oil_leader" label="分销商姓名" align="center">

                </el-table-column>
                <el-table-column prop="leader_phone" label="电话" align="center">
                ...
                <el-table-column  label="金额" align="center">
                     <template slot-scope="scope">
                           <el-button  type="text" size="small" @click="oil_shop_id=scope.row,ProfitVisible=true,Profit(scope.row)">{{scope.row.num}}</el-button>
                     </template>
                </el-table-column>
                 <el-table-column prop="leader_phone" label="支付凭证" align="center">
                     
                </el-table-column>
                  <el-table-column prop="leader_phone" label="申请时间" align="center">
                     
                </el-table-column>
                <el-table-column prop="date" label="设备号" align="center">
                    <template slot-scope="scope">
                        <el-button  type="primary" size="small" @click="cancelData=scope.row,cancelVisible=true">查看</el-button>

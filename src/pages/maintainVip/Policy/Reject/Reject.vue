  ...
  <div class='adopt' ref='adopt'>
    <table class='table'>
      ...
      <tr v-for="item in list">
        ...
        <td>
          <a href="javascript:;" @click='reason=item.reason,reasonVisible=true'>查看</a>
        </td>
    ...
    <!--详情弹框-->
    <el-dialog title="详情" :visible.sync="detailsVisible" v-drag width="800px" center>
      <div class='details'>
        <div class='content'>
          <!--保单信息-->
          ...
          <div class='Photo'>
            <ul>
              <li v-for='(item,key) in information.pc_img'><img :src="item" @click="ImgDialogVisible=true,ImgList=item,enlarge()"></li>
            </ul>
          </div>
        </div>
      </div>
    </el-dialog>
    <el-dialog title="驳回理由"  :visible.sync="reasonVisible" v-drag width="800px" center>
...
//              this.positionY = left;
    ...
    methods:{
      ...
      init(){
        this.$axios.post('admin/PolicyAudit/rejList',{token:this.token,page:this.page}).then(res=>{
          if(res.data.code==1){

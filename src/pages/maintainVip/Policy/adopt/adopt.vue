    ...
    <el-dialog title="详情"
      ...
      <div class='details'>
        <div class='content'>
          ...
          <div class='Photo'>
            <ul>
              <li v-for='(item,index) in information.pc_img'
...
export default {
  ...
  methods: {
    ...
    init () {
      this.$axios.post('admin/PolicyAudit/adoptList', { token: this.token, page: this.page }).then(res => {
        if (res.data.code == 1) {

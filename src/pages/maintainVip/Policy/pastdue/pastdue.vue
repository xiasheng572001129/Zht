<template>
  <div class='adopt' ref='adopt'>
    ...
    <!--详情弹框-->
    <el-dialog title="详情" v-drag :visible.sync="detailsVisible" width="700px" center>
      <div class='details'>
        <div class='content'>
          <!--保单信息-->
...
//              this.positionY = left;
    ...
    methods:{
      ...
      init(){
        this.$axios.post('admin/PolicyAudit/overList',{token:this.token,page:this.page}).then(res=>{
          if(res.data.code==1){

<template>
  <div>
    ...
    <div class="container">
      <div class="quote">
        <div class="quote-ele"
             style="float:left"><i></i>供应商-赠品信息 </div>
      </div>
      <div class="search">
      ...
      <el-table :data='list'>
        ...
        <el-table-column label="礼品名称"
                         align="center"
                         prop="gifts_name"></el-table-column>
        <el-table-column label="应缴纳质保金"
                         align="center"
                         prop="set_retention_money"></el-table-column>
        <el-table-column label="已缴纳质保金"
                         align="center"
                         prop="my_retention_money"></el-table-column>
      </el-table>
      <!-- 供应商信息详情 -->
...
export default {
  ...
  methods: {
    ...
    async init () {
      try {
        const res = await this.$axios.post('admin/SmList/getGiftsIndexList', { token: this.token, page: this.page, sm_name: this.sm_name })

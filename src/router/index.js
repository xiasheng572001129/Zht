...
const routes = [
  ...
  {
    path: '/oA',
    redirect: '/oA/AdministratorAudit/unaudited'
  },
  { //oA审核-审核管理员-未审核
    path: '/oA/AdministratorAudit/unaudited',
    component: () => import('@/pages/oA/AdministratorAudit/unaudited'),
    meta: {
      auth: true
    }
  },
  { //oA审核-审核管理员-已审核
    path: '/oA/AdministratorAudit/audited',
    component: () => import('@/pages/oA/AdministratorAudit/audited'),
    meta: {
      auth: true
    }
  },
  { //oA审核-审核管理员-已驳回
    path: '/oA/AdministratorAudit/rejected',
    component: () => import('@/pages/oA/AdministratorAudit/rejected'),
    meta: {
      auth: true
    }
  },
  ...
  { //oA审核-增加地区-未审核
    path: '/oA/regionAudit/unaudited',
    component: () => import('@/pages/oA/regionAudit/unaudited'),
    meta: {
      auth: true
    }
  },
  { //oA审核-增加地区-已审核
    path: '/oA/regionAudit/audited',
    component: () => import('@/pages/oA/regionAudit/audited'),
    meta: {
      auth: true
    }
  },
  { //oA审核-增加地区-已驳回
    path: '/oA/regionAudit/rejected',
    component: () => import('@/pages/oA/regionAudit/rejected'),
    meta: {
      auth: true
    }
  }
